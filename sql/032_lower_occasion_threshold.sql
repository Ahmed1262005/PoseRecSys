-- =====================================================
-- Lower Occasion Threshold from 0.30 to 0.18
-- Run after 031_add_scores_to_keyset.sql
--
-- Analysis showed:
-- - Median office score: 0.19
-- - Threshold 0.30: Only 0.2% items pass (too strict!)
-- - Threshold 0.18: ~70% items pass (reasonable filter)
--
-- Lowering to 0.18 ensures occasion filtering works
-- without over-filtering the user's preferred brands.
-- =====================================================

-- Update get_exploration_keyset_with_brands
...
CREATE OR REPLACE FUNCTION get_exploration_keyset_with_brands(
    ...
    occasion_threshold float DEFAULT 0.18,  -- LOWERED from 0.30
...
-- Verification
SELECT 'Occasion threshold lowered to 0.18' as status;

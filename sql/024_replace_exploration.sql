-- Force replace get_exploration_keyset with working lifestyle filters
-- First drop with CASCADE to remove all dependent objects
DROP FUNCTION IF EXISTS get_exploration_keyset CASCADE;

CREATE FUNCTION get_exploration_keyset(
...
SELECT 'get_exploration_keyset replaced with lifestyle filters' as status;

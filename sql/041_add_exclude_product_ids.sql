-- =====================================================
-- Add exclude_product_ids parameter to exploration keyset functions
--
-- Problem: Seen history exclusion was done in Python AFTER fetching
-- from SQL. This wasted fetch budget — if SQL returned 150 rows
-- and 100 were already seen, only 50 usable candidates remained.
--
-- Solution: Add exclude_product_ids uuid[] parameter to both
-- get_exploration_keyset and get_exploration_keyset_with_brands.
-- SQL excludes seen items directly, so every row returned is
-- guaranteed unseen. Postgres handles NOT (id = ANY(uuid[]))
-- efficiently for arrays up to ~5000 elements.
--
-- Impact:
--   Fresh user:  150 candidates -> 500 candidates
--   500 seen:    150 usable -> 500 usable (seen excluded in SQL)
--   1166 seen:   150 usable -> 500 usable (seen excluded in SQL)
--   5000+ seen:  could get 0 -> 500 usable (seen excluded in SQL)
-- =====================================================

-- =============================================================
-- get_exploration_keyset: Add exclude_product_ids parameter
-- =============================================================

-- Drop old signature (without exclude_product_ids)
...
BEGIN
    ...
    WHERE p.in_stock = true
      ...
      -- Seen history exclusion (NEW) - exclude products the user has already seen
...
-- =============================================================
-- get_exploration_keyset_with_brands: Add exclude_product_ids parameter
-- =============================================================
...
SELECT 'Added exclude_product_ids parameter to exploration keyset functions for SQL-level seen history exclusion' as status;

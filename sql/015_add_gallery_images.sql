-- Add gallery_images to all keyset functions for carousel support
-- This enables the frontend to show multiple images on hover
...
-- Verify
-- =====================================================
SELECT 'gallery_images added to all keyset functions' as status;

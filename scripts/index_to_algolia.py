...
def fetch_products_batch(supabase, offset: int, batch_size: int, brand: str = None):
    ...
    query = supabase.table("products").select(
        ...
        "primary_image_url, gallery_images, created_at, "
        "gender, "
        ...
        "  source_description, set_features, "
        "  arm_coverage, shoulder_coverage, neckline_depth, midriff_exposure, "
        "  back_openness, sheerness_visual, "
        "  body_cling_visual, structure_level, drape_level, bulk_visual, "
        "  cropped_degree, waist_definition_visual, leg_volume_visual, "
        "  has_pockets_visible, pocket_details, slit_presence, slit_height, "
